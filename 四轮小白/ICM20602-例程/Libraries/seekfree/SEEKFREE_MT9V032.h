...
#define COL     100//图像宽度   范围1-752     K60采集不允许超过188
#define ROW     40//图像高度	范围1-480
...
//--------------------------------------------------------------------------------------------------
#define MT9V032_PCLK               C14// A28                            	//摄像头像素时钟
        
#define MT9V032_VSYNC              C19// A27                            	//摄像头场同步信号
#define MT9V032_VSYNC_CHANNEL      19// 27                               //MT9V032_VSYNC对应引脚的引脚号 PTC6   -->     6
#define MT9V032_INTERRUPT_NUNBERS   PORTC_IRQn //PORTA_IRQn                      //中断编号
#define MT9V032_INTERRUPT_ISFR      PORTC->ISFR//PORTA->ISFR                     //中断标志位
