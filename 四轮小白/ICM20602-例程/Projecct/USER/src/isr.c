...
void PIT0_IRQHandler(void)
{
      ...
      {
            S3010DutyOutput=SpaceAdPID(&S3010DutyInductive);
            S3010DutyOutput=limit_ab(S3010DutyOutput,ServoRightMax,ServoLeftMax);
            ftm_pwm_duty(ftm1,ftm_ch1,S3010DutyOutput);  //舵机控制
      }
      
      Differential(S3010DutyInductive.Err);
      
      {
            LeftMotorSpeedContural();
            RightMotorSpeedContural();
